...
namespace ClassHeriarchy
{
    public partial class MainPage : ContentPage
    {
        public MainPage()
        {
            ...
            ClassesAndSubclasses rootClass = new ClassesAndSubclasses(typeof(Object), false);
        ...
        void AddChildrenToParent(ClassesAndSubclasses parentClass,
                                 List<TypeInformation> classList)
        {
            foreach (TypeInformation typeInformation in classList)
            {
                ...
                {
                    ClassesAndSubclasses subClass =
                        new ClassesAndSubclasses(typeInformation.Type, typeInformation.IsXamarinForms);
        ...
        void AddItemToStackLayout(ClassesAndSubclasses parentClass, int level)
        {
            ...
            foreach (ClassesAndSubclasses subclass in parentClass.Subclasses)
            {
